            ...
            <div class="inner">
                <div class="content_fir">
                    ...
                    <div>
                        <li>
                            <label for="field1">
                            <input id="field1"type="radio" name="field" value="pd">공개</label>
                        </li>  
                        <li>
                            <label for="field2">
                            <input id="field2"type="radio" name="field" value="pd">비공개</label>
                        </li>  
                    </div>
                    <div class="basicDataTable aLeft" mb30>
                        <form name="detailForm" method="" action=""> 
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">
                                            ...
                                            <td colspan="3">
                                                <input type="text" id="tit" name="subject" title="제목 입력" value>
                                            </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                    ...
                    <div class="btnArea">
                        ...
                        <div class="rightArea">
                            ...
                            <a href="#" id="dInsert" class="btn btntype03 btnRed">
                                <span>등록</span>
                            </a>
                        </div>
                    </div>
