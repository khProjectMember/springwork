            ...
            <div id="header_1_right">
            	<c:choose>
	            	<c:when test="${ empty loginUser }">
		                ...
		                <a data-toggle="modal" data-target="#loginModal">로그인</a> <!-- 모달의 원리 : 이 버튼 클릭시 data-target에 제시되어있는 해당 아이디의 div가 보여짐 -->
		            </c:when>
		            <c:otherwise>   
		                <!-- 로그인 후 -->
		                <label>${ loginUser.userName }님 환영합니다</label>&emsp;
            ...
            <div class="modal-content">
                ...
                <form action="login.me" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <input class="form-control mb-2 mr-sm-2" placeholder="Enter ID" id="userId" name="userId"><br>
